...
if !exists("g:DiableAutoPHPFolding")
    let g:DiableAutoPHPFolding = 0
endif
" }}}
...
" Check filetype == php before automatically creating folds {{{1
function! s:CheckAutocmdEnablePHPFold()
    if &filetype == "php" && ! g:DiableAutoPHPFolding
        call s:EnableFastPHPFolds()
    endif
endfunction
" }}}

" Call EnableFastPHPFolds on BufReadPost {{{1
augroup SetPhpFolds
    au!
